...
- New installs should use `[p]cog install taakoscogs toolz` and `[p]load toolz`.
- Existing Toolz settings are preserved because the cog's Config identifier did not change.
