...
- Renamed the repository package folder from `EmojiPorter` to `emojiporter` to match Red cog naming standards.
- New installs should use `[p]cog install taakoscogs emojiporter` and `[p]load emojiporter`.
