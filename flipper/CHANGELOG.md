...
- Renamed the repository package folder from `Flipper` to `flipper` to match Red cog naming standards.
- New installs should use `[p]cog install taakoscogs flipper` and `[p]load flipper`.
