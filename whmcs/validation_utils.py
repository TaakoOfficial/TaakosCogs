...
def validate_invoice_id(invoice_id: str | int) -> int:
...
def validate_ticket_id(ticket_id: str | int) -> int:
...
def validate_page_number(page: str | int) -> int:
...
def validate_limit(limit: str | int) -> int:
...
def validate_role_id(role_id: str | int) -> int:
