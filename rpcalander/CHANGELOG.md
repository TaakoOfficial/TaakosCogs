...
- New installs should use `[p]cog install taakoscogs rpcalander` and `[p]load rpcalander`.
- Existing RP calendar settings and tracker data are preserved because the cog's Config identifier did not change.
