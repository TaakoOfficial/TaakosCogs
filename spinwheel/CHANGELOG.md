...
- Added optional winner removal, default wheels, member access controls, and configurable entry limits.
- Added a standalone visual Red-Web-Dashboard builder, saved-wheel editor, and browser spinner.
